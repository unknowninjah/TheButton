...
Explore
 @eduenas Sign out
0
0 0 eduenas/TheButton
 Code  Issues 0  Pull requests 0  Projects 0  Wiki  Insights  Settings
TheButton/TheButton.ahk
e29772e  13 days ago
@eduenas eduenas Update TheButton.ahk
     
225 lines (221 sloc)  23.5 KB
...
sendinput if omreport system esmlog 2>/dev/null|grep '+4full' --silent`; then echo -e +4+[ORNGE+]----------- +4+[GRN+]LOGS +4+[ORNGE+]-----------------------------------------------------+4+[NC+]`; echo Critical: Server Logs Full.`; fi &&
sendinput if omreport system esmlog 2>/dev/null|grep 'low battery is low.' --silent`; then echo -e +4+[ORNGE+]----------- +4+[GRN+]CMOS BATTERY +4+[ORNGE+]---------------------------------------------+4+[NC+]`; echo "CMOS Battery Replacement Required: Yes"`; else if omreport chassis batteries 2>/dev/null|grep Status|grep -v Reading|grep 'Unknown\|Missing\|Degraded\|Critical\|Failed' --silent`; then echo -e +4+[WHITE+]----------- CMOS BATTERY ---------------------------------------------+4+[NC+]`; echo "CMOS Battery Replacement Required: Yes"`; omreport chassis batteries 2>/dev/null|awk 'NF'`;  fi`; fi &&
